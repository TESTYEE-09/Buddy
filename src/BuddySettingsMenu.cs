    ...
    internal static class BuddySettingsMenu
    {
        ...
        internal static void Register()
        {
            ...
            var components = new MenuComponent[]
            {
                ...
                _status,
                new LabelComponent { Text = "Voice only", FontSize = 19f },
                new ToggleComponent
                {
                ...
                new ToggleComponent
                {
                    Text = "Speak Buddy replies aloud",
                ...
                new ToggleComponent
                {
                    Text = "Save Buddy voice-turn results, observations and tool results",
                ...
                new LabelComponent
                {
                    Text = "Voice-only replies are generated by Realtime. Typed chat is ignored. Response saving is opt-in; enable it only after everyone in the lobby agrees.",
                    FontSize = 11f
                }
            };
